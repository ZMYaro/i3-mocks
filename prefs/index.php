		...
		<div class="pane" id="mainPane">
			...
			<div class="paneContent">
				<ul class="menu">
					...
					<li><a href="#" onclick="clickedTab(this.parentElement);openSubPane('intraboxes.ejs');"><img src="../blank.png" alt="" /> Intraboxes</a></li>
...
<!--					<li><a href="#" onclick="clickedTab(this.parentElement);openSubPane(prefs.eighth);"><img src="../public/images/themes/default/modules/eighth/icon.png" alt="" /> Eighth Period</a></li> -->
					...
					<li><a href="#" onclick="clickedTab(this.parentElement);openSubPane('joke.ejs');"><img src="../blank.png" alt="" /> Other</a></li>
				</ul>
			</div>
		</div>
	</body>

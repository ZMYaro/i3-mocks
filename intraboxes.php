			...
			<script type="text/javascript">
				window.addEventListener("load", function() {
					setInterval(function() {
						var date = new Date();
						document.getElementById("clock").innerHTML = ((date.getHours() % 12 < 10 && date.getHours() % 12 != 0) ? "0" : "") + (date.getHours() % 12 != 0 ? date.getHours() % 12 : "12") + ":" + (date.getMinutes() < 10 ? "0" : "") + date.getMinutes() + ":" + (date.getSeconds() < 10 ? "0" : "") + date.getSeconds();
					}, 200);
				}, false);
			</script>
		</div>
